...
// MvcMfcDestopApp.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CMvcMfcDestopAppApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CMvcMfcDestopAppApp construction

CMvcMfcDestopAppApp::CMvcMfcDestopAppApp()
{
...
// The one and only CMvcMfcDestopAppApp object

CMvcMfcDestopAppApp theApp;


// CMvcMfcDestopAppApp initialization

BOOL CMvcMfcDestopAppApp::InitInstance()
{
